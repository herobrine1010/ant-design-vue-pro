// import { compressImage } from 'wangeditor/release/compressImage'
...
UploadImg.prototype = {
    ...
    uploadImg: function uploadImg(files) {
        ...
        arrForEach(files, function (file) {
          console.log(file)
            ...
            // compressImage.compressImage(file)
            //   .then(result => {
            //     console.log(result)
  ...
  compressImage: function compressImage(path){
    ...
    image.onload = function() {
      ...
      //压缩完成
      var img = document.getElementById("avarimgs"+num);//获取图片id
      img.src = data;//给图片src路径赋值


      //此处为上传图片到服务器 所传图片值为data
      var baseUrl = process.env.API_ROOT;
      var formData = new FormData();
      formData.append("source", 3);
      formData.append("base64_image", data);
      axios.post(baseUrl + "apiyd/base/uploadBase64ImgInfo", formData)
        .then(res => {
          if (res.data.code == 1000) {
            that.formList.company_pics=res.data.data.im_age_url
          } else {
